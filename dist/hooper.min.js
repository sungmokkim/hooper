      ...
      a = {
        ...
        methods: {
            ...
            if (!this.isSliding && t !== this.currentSlide) {
              ...
              this.group && n && f.$emit('slideGroup:'.concat(this.group), t),
                ...
                window.setTimeout(function() {
                  (e.isSliding = !1), (e.currentSlide = c(h, e.slidesCount));
                }, s),
          ...
          getCurrentSlideTimeout: function() {
            var t = c(this.currentSlide, this.slidesCount);
                    ...
                    this.config.infiniteScroll &&
                      (r = (function(t, i) {
                        for (var e = [], n = [], r = i.length, o = 0; o < r; o++) {
                          ...
                          var c = d(t, s);
                          (h = o + r),
                            (c.data.key = 'after_'.concat(h)),
                            (c.componentOptions.propsData.index = h),
                            (c.key = c.data.key),
                            (c.data.props = { index: h, isClone: !0 }),
                            n.push(c);
                        }
      ...
      y = {
        ...
        computed: {
          currentSlide: function() {
            return c(this.$hooper.currentSlide, this.$hooper.slidesCount);
          },
          progress: function() {
