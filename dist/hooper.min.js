  ...
  (i = function(t, i) {
      ...
      a = {
        ...
        methods: {
          slideTo: function(t, i) {
            ...
            if (!this.isSliding && t !== this.currentSlide) {
              ...
              this.group && r && f.$emit('slideGroup:'.concat(this.group), t),
                (this.currentSlide = h),
                (this.isSliding = !0),
        ...
        render: function(t) {
          var i = this,
            e = function(t) {
              var i = function(t) {
                  for (var i = p(this), e = i.length, r = 0, n = [], o = 0; o < e; o++) {
                    var s = i[o],
    ...
    function w(t, i, e, r, n, o) {
      ...
      return t(
        'button',
        {
          class: ((s = {}), u(s, 'hooper-'.concat(r ? 'prev' : 'next'), !0), u(s, 'is-disabled', i), s),
          attrs: { type: 'button' },
          on: { click: o }
        },
        l
