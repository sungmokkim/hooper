  ...
  (i = function(t, i) {
    ...
    var r =
      ...
      function(t) {
        ...
        for (var i = Object(t), e = 1; e < arguments.length; e++) {
          ...
          if (null != o) {
            o = Object(o);
            for (var n = Object.keys(Object(o)), r = 0, s = n.length; r < s; r++) {
              var a = n[r],
                h = Object.getOwnPropertyDescriptor(o, a);
              void 0 !== h && h.enumerable && (i[a] = o[a]);
            }
          }
        }
        return i;
      ...
      a = {
          ...
          trackTransform: function() {
            var t = this.config,
              ...
              h =
                ...
                r * ((n ? (a - s) / 2 : 0) - (i ? s * this.slidesCount : 0) - this.currentSlide * s);
            return e
              ? 'transform: translate(0, '.concat(h, 'px);')
              : this.slideBounds.upper === this.slidesCount - 1
              ? 'transform: translate('.concat(h, 'px, 0);')
              : 'transform: translate('.concat(h + this.horizontalMargin, 'px, 0);');
          },
        ...
        methods: {
          slideTo: function(t, i) {
            var e = this,
              o = !(1 < arguments.length && void 0 !== i) || i;
            if (!this.isSliding && t !== this.currentSlide) {
              ...
              this.group && o && f.$emit('slideGroup:'.concat(this.group), t),
                (this.currentSlide = h),
                (this.isSliding = !0),
                window.setTimeout(function() {
                  (e.isSliding = !1), (e.currentSlide = u(h, e.slidesCount));
                }, s),
                this.$emit('slide', { currentSlide: this.currentSlide, slideFrom: a }),
                this.slideBounds.upper === this.slidesCount - this.numberBeforeOnLastItem &&
          ...
          updateTrim: function() {
            ...
            (this.trimStart = o ? Math.floor((e - 1) / 2) : 0), (this.trimEnd = o ? Math.ceil(e / 2) : e);
          },
            ...
            (this.containerWidth = t.width),
              ...
              this.config.vertical
                ...
                : ((this.slideWidth = this.containerWidth / this.config.itemsToShow),
                  (this.containerWidth = this.containerWidth + 2 * this.horizontalMargin));
          },
          ...
          onDragEnd: function() {
            ...
            if (!this.config.vertical) {
              ...
              this.slideTo(this.currentSlide - e * o);
            }
            (this.delta.x = 0),
              (this.delta.y = 0),
        ...
        render: function(t) {
          var i = this,
            e = function(t) {
              var i = function(t) {
                  for (var i = p(this), e = i.length, o = 0, n = [], r = 0; r < e; r++) {
                    var s = i[r],
                      a = s.componentOptions && s.componentOptions.Ctor;
                    a &&
                      'HooperSlide' === a.options.name &&
                      ((s.componentOptions.propsData.index = o),
                      (s.data.key = o),
                      (s.key = o),
                      (s.data.props = h({}, s.data.props || {}, { isClone: !1, index: o++, isSmooth: this.isSmooth })),
                      n.push(s));
                  }
                  (this.slidesCount = n.length),
                    this.config.infiniteScroll &&
                      (n = (function(t, i) {
                        for (var e = [], o = [], n = i.length, r = 0; r < n; r++) {
                          var s = i[r],
                            a = d(t, s),
                            h = r - n;
                          (a.data.key = 'before_'.concat(r)),
                            ...
                            (a.data.props = { index: h, isClone: !0, isSmooth: this.isSmooth }),
                            e.push(a);
                          var u = d(t, s);
                          (h = r + n),
                            ...
                            (u.key = u.data.key),
                            (u.data.props = { index: h, isClone: !0, isSmooth: this.isSmooth }),
                            o.push(u);
                        }
                        return [].concat(e, c(i), o);
                      })(t, n));
                  return t(
                    'ul',
                    {
    ...
    var m = {
        ...
        props: {
          ...
          isSmooth: { type: Boolean, required: !0 }
        },
        computed: {
          style: function() {
            var t = this.$hooper || {},
              ...
              e = t.slideHeight,
              o = t.slideWidth;
            return i.vertical ? 'height: '.concat(e, 'px;') : 'width: '.concat(o, 'px;');
          },
          isActive: function() {
          ...
          transition: function() {
            return this.isSmooth ? 'transition: 0.2s ease-in-out;' : null;
          },
          opacity: function() {
            return this.isSmooth ? (this.isActive ? 'opacity: 1;' : 'opacity: 0;') : null;
          }
        },
        render: function(t) {
          var i = {
      ...
      v = {
        ...
        render: function(t, i) {
          ...
          return (
            ...
            n.push(t('path', { attrs: { d: 'M0 0h24v24H0z', fill: 'none' } })),
            n.push(t('path', { attrs: { d: o } })),
            t(
              'svg',
    ...
    function y(i, e, t, o) {
      for (
            ...
            n.push(
              (function(t, i, e, o) {
                return t('li', [
                  t(
                    'button',
                    { class: { 'hooper-indicator': !0, 'is-active': e }, on: { click: o }, attrs: { type: 'button' } },
        ...
        r(s);
      return [i('ol', { class: 'hooper-indicators' }, n)];
    }
    var $ = {
      inject: ['$hooper'],
      ...
      render: function(t) {
        var i = this,
          ...
          o =
            'indicator' === this.mode
              ? y(t, this.currentSlide, e, function(t) {
                  return i.$hooper.slideTo(t);
                })
              : (function(t, i, e) {
                  return [t('span', i + 1), t('span', '/'), t('span', e)];
                })(t, this.currentSlide, e);
        return t('div', { class: { 'hooper-pagination': !0, 'is-vertical': this.$hooper.config.vertical } }, o);
      }
    };
    function w(t, i, e, o, n, r) {
      var s,
        a = n.isVertical,
        h = n.isRTL,
        u =
      ...
      return t(
        'button',
        {
          class: ((s = {}), l(s, 'hooper-'.concat(o ? 'prev' : 'next'), !0), l(s, 'is-disabled', i), s),
          attrs: { type: 'button' },
          on: { click: r }
        },
        u
