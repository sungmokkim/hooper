  ...
  (i = function(t, i) {
    ...
    var r =
      ...
      function(t) {
        ...
        for (var i = Object(t), e = 1; e < arguments.length; e++) {
          ...
          if (null != n) {
            n = Object(n);
            for (var o = Object.keys(Object(n)), r = 0, s = o.length; r < s; r++) {
              var a = o[r],
      ...
      a = {
          ...
          trackTransform: function() {
            var t = this.config,
              ...
              h =
                ...
                r * ((o ? (a - s) / 2 : 0) - (i ? s * this.slidesCount : 0) - this.currentSlide * s);
            return e
        ...
        methods: {
          ...
          getCurrentSlideTimeout: function() {
            var t = l(this.currentSlide, this.slidesCount);
          ...
          updateTrim: function() {
            var t = this.config,
              ...
              n = t.centerMode,
              o = t.infiniteScroll;
            if (!i || o) return (this.trimStart = 0), void (this.trimEnd = 1);
              ...
              var i = function(t) {
                  for (var i = p(this), e = i.length, n = 0, o = [], r = 0; r < e; r++) {
                    ...
                    a &&
                      ...
                      (s.data.key = n),
                      (s.key = n),
                      (s.data.props = h({}, s.data.props || {}, { isClone: !1, index: n++, isSmooth: this.isSmooth })),
                      o.push(s));
                  }
    ...
    var g = {
        ...
        render: function(t) {
          var i = {
            ...
            e = p(this);
          return t('li', { class: i, style: this.style + this.opacity, attrs: { 'aria-hidden': !this.isActive } }, e);
        }
      },
      m = {
    ...
    function w(t, i, e, n, o, r) {
      ...
      return t(
        'button',
        {
          class: ((s = {}), u(s, 'hooper-'.concat(n ? 'prev' : 'next'), !0), u(s, 'is-disabled', i), s),
          attrs: { type: 'button' },
          on: { click: r }
        },
        l
