...
(t = this),
  (i = function(t, i, e, r) {
    ...
    var g = new r(),
      m = {
        ...
        watch: {
          group: function(t, i) {
            t !== i && (g.$off('slideGroup:'.concat(i), this._groupSlideHandler), this.addGroupListeners());
          },
        ...
        methods: {
          slideTo: function(t, i) {
            var e = this,
              r = !(1 < arguments.length && void 0 !== i) || i;
            if (!this.isSliding && t !== this.currentSlide) {
              ...
              this.group && r && g.$emit('slideGroup:'.concat(this.group), t),
                (this.currentSlide = h),
                (this.isSliding = !0),
          ...
          getCurrentSlideTimeout: function() {
            ...
            return f(this)[t].componentOptions.propsData.duration;
          },
          initAutoPlay: function() {
            var t = this;
            this.timer = new s(function() {
          ...
          initDefaults: function() {
            (this.breakpoints = this.settings.breakpoints),
              (this.defaults = a({}, this.$props, this.settings)),
              (this.config = a({}, this.defaults));
          },
          update: function() {
          ...
          updateTrim: function() {
            ...
            (this.trimStart = r ? Math.floor((e - 1) / 2) : 0), (this.trimEnd = o || (r ? Math.ceil(e / 2) : e));
          },
            ...
            Object.keys(this.breakpoints)
              ...
              .some(function(t) {
                if ((i = window.matchMedia('(min-width: '.concat(t, 'px)')).matches))
                  return (e.config = a({}, e.config, e.defaults, e.breakpoints[t])), !0;
              }),
              i || (this.config = a(this.config, this.defaults));
          },
          ...
          onDragEnd: function() {
            ...
            if (((this.isDragging = !1), this.config.vertical)) {
              ...
              this.slideTo(this.currentSlide - p(this.delta.y) * i);
            }
            if (!this.config.vertical) {
              var e = (this.config.rtl ? -1 : 1) * p(this.delta.x),
                r = Math.round(Math.abs(this.delta.x / this.slideWidth) + t);
              this.slideTo(this.currentSlide - e * r);
            }
            (this.delta.x = 0),
              (this.delta.y = 0),
          ...
          onWheel: function(t) {
            if ((t.preventDefault(), !(o() - this.lastScrollTime < 200))) {
          ...
          addGroupListeners: function() {
            ...
            this.group &&
              ...
              g.$on('slideGroup:'.concat(this.group), this._groupSlideHandler));
          }
        },
        created: function() {
          this.initDefaults();
        ...
        beforeDestroy: function() {
          window.removeEventListener('resize', this.update),
            this.group && g.$off('slideGroup:'.concat(this.group), this._groupSlideHandler),
        ...
        render: function(t) {
          var i = this,
            e = function(t) {
              var i = function(t) {
                  for (var i = f(this), e = i.length, r = 0, n = [], o = 0; o < e; o++) {
                    var s = i[o],
                    ...
                    a &&
                      ...
                      (s.data.key = r),
                      (s.key = r),
                      (s.data.props = h({}, s.data.props || {}, { isClone: !1, index: r++ })),
                      n.push(s));
                  }
        ...
        computed: {
          style: function() {
            var t = this.$hooper || {},
              ...
              e = t.slideHeight,
              r = t.slideWidth;
            return i.vertical ? 'height: '.concat(e, 'px;') : 'width: '.concat(r, 'px;');
          },
          isActive: function() {
            ...
            n.push(
              (function(t, i, e, r) {
                return t('li', [
                  t(
                    'button',
                    { class: { 'hooper-indicator': !0, 'is-active': e }, on: { click: r }, attrs: { type: 'button' } },
    ...
    var b = {
      ...
      render: function(t) {
        var i = this,
          ...
          r =
            'indicator' === this.mode
              ? w(t, this.currentSlide, e, function(t) {
    ...
    function T(t, i, e, r, n, o) {
      ...
      return t(
        'button',
        {
          class: ((s = {}), c(s, 'hooper-'.concat(r ? 'prev' : 'next'), !0), c(s, 'is-disabled', i), s),
          attrs: { type: 'button' },
          on: { click: o }
        },
        u
    ...
    var x = {
      ...
      render: function(t) {
        var i = this,
          ...
          r = [
            T(t, this.isPrevDisabled, this.$slots['hooper-prev'], !0, e, function() {
              return i.slidePrev();
            }),
            T(t, this.isNextDisabled, this.$slots['hooper-next'], !1, e, function() {
              return i.slideNext();
            })
          ];
        return t(
  ...
  'object' == typeof exports && 'undefined' != typeof module
    ? i(exports, require('core-js/modules/es.array.from'), require('regenerator-runtime/runtime'), require('vue'))
    : 'function' == typeof define && define.amd
    ? define(['exports', 'core-js/modules/es.array.from', 'regenerator-runtime/runtime', 'vue'], i)
    : i(((t = t || self).Hooper = {}), 0, 0, t.Vue);
