...
(t = this),
        ...
        methods: {
          ...
          onDragEnd: function() {
            ...
            if (((this.isDragging = !1), this.config.vertical)) {
              ...
              this.slideTo(this.currentSlide - a(this.delta.y) * i);
            }
            if (!this.config.vertical) {
              var e = (this.config.rtl ? -1 : 1) * a(this.delta.x),
  ...
  'object' == typeof exports && 'undefined' != typeof module
    ? i(exports, require('core-js/features/array/from'), require('vue'))
    : 'function' == typeof define && define.amd
    ? define(['exports', 'core-js/features/array/from', 'vue'], i)
    : i(((t = t || self).Hooper = {}), 0, t.Vue);
